...
export type TrackByIdAndSameArtistTracksQuery = (
  { __typename?: 'Query' }
  & { trackByIdAndSameArtistTracks: (
    { __typename?: 'IdAndArtistTracks' }
    & { track: (
      { __typename?: 'Track' }
      & TrackSnippetFragment
...
export function useTrackByIdAndSameArtistTracksQuery(options: Omit<Urql.UseQueryArgs<TrackByIdAndSameArtistTracksQueryVariables>, 'query'> = {}) {
  return Urql.useQuery<TrackByIdAndSameArtistTracksQuery>({ query: TrackByIdAndSameArtistTracksDocument, ...options });
};
